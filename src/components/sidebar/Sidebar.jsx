              ...
              if (!searchTerm || item.name.toLowerCase().includes(searchTerm.toLowerCase())) {
                return (
                  <li key={index} className="px-2 py-1 template-item bg-gray-100 rounded-lg hover:bg-gray-200 transition-all duration-200 flex items-center justify-between mb-3">
                    ...
                    <path d="M11.8896 5.0498C12.3196 7.8098 14.5596 9.9198 17.3396 10.1998" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span className="hover:bg-gray-300 p-1.5 rounded-lg transition-all duration-300">
                      ...
                      <path d="M18.8504 9.13965L18.2004 19.2096C18.0904 20.7796 18.0004 21.9996 15.2104 21.9996H8.79039C6.00039 21.9996 5.91039 20.7796 5.80039 19.2096L5.15039 9.13965" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
